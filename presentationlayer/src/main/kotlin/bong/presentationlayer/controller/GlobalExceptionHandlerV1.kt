...
class GlobalExceptionHandlerV1(
    ...
    private val factory: V1ApiErrorResponseFactory
) {
    ...
    ): ResponseEntity<V1ResponseBody> {
        val body = factory.userNotFound(ex.userIdentifier, ex.transactionId) as V1ResponseBody
    ...
    fun handleNotReadable(
        ...
        val body = factory.badRequest() as V1ResponseBody
    ...
    fun handleException(
        ...
        val body = factory.internalError() as V1ResponseBody
